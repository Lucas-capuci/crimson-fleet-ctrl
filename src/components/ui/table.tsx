  ...
  ({ className, ...props }, ref) => (
    <tr
      ...
      className={cn(
        ...
        "data-[state=selected]:bg-primary/5 hover:bg-secondary/50",
        className
      )}
      {...props}
    />
...
const TableHead = React.forwardRef<HTMLTableCellElement, React.ThHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => (
    <th
      ref={ref}
      className={cn(
        "h-12 px-4 text-left align-middle font-semibold text-muted-foreground text-caption uppercase tracking-wider",
